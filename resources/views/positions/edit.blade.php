            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('nama_jabatan') border-red-500 @enderror"
                        required
                    />
                    @error('nama_jabatan')
